...
target_table_id = 'CustOpsResults'
TIMEOUT = 30
...
query_job = bq.query('SELECT ' + source_target_table_id + ',' + source_target_table_column_name + ' FROM `' + PROJECT_ID + '.' + DATASET_ID + '.' + source_table_id + '` LIMIT 150 OFFSET 3100')
# 3100 - 3250
