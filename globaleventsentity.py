...
source_table_id = 'SMGlobalEvents'
target_table_id = 'SMGlobalExpectationEntity'
TIMEOUT = 30

# This is the column to pull data from to run NLP
source_target_table_id = 'Respondent_ID'
source_target_table_column_name = 'Expectation'

# Schema for target table
SCHEMA = [
        bigquery.SchemaField('id', 'INTEGER', mode='required'),
        bigquery.SchemaField('Expectation', 'STRING', mode='required'),
